...
public interface ContactService {
	 ...
	 *
	 * @param criteria {@link ContactSearchCriteriaDTO}
	 * @return All matched entities converted into a list of {@link ContactDTO}s, or
	 *         an empty {@link List} if not found
	 */
	 ...
	 *
	 * @param contactDTO The id of this DTO must not be null
	 * @return The updated {@link Contact} entity converted into a
	 *         {@link ContactDTO}
	 * @throws javax.persistence.EntityNotFoundException if no entity corresponding
	 *                                                   to the {@link ContactDTO}
	 *                                                   could be found
	 */
	ContactDTO updateByDTO(ContactDTO contactDTO) throws EntityNotFoundException;

	List<ContactDTO> listByNameContainingIgnoreCase(ContactSearchCriteriaDTO criteria);

	List<ContactDTO> listByLastnameContainingIgnoreCase(ContactSearchCriteriaDTO criteria);

	List<ContactDTO> listByCriteriaFetchName(ContactSearchCriteriaDTO criteria);
}
