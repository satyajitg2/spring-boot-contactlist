...
<%--             <div class="form-group">
                <label for="organisationDate" class="col-md-3 control-label">Date</label>
                <div class="col-sm-6">
                    <form:input path="organisationDate" type="text" cssClass="form-control" id="organisationDate" placeholder="Organisation Date" />
                </div>
                <div class="col-sm-3"></div>
            </div> --%>
